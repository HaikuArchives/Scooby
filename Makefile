...
ifeq ($(MACHINE), BePC)
	CPU = x86
	LIBS += ./libs/Utils/libUtils.a ./libs/Santa/sgb.a ./libs/Toolbar/libToolbar.a
else
	CPU = ppc
	NAME = Scooby_ppc
	LIBS += mslcpp_4_0 ./libs/Utils/libUtils_ppc.a ./libs/Santa/sgb_ppc.a ./libs/Toolbar/libToolbar_ppc.a
endif
